...
/**
 * Generates a random secret key for dapp.
 * 
 ...
 * Based on RWA-API pattern, witnesses provide access to private state
 * during ZK proof generation.
 */
export const witnesses = {
  /**
   * Returns caller's secret key from private state
  ...
  /**
   * Returns ask party's secret key for order matching
...
/**
 * Private state contains dapp's secret key
 * This key is used to derive public key that's stored in contract
 */
