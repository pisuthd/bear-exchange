    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0f172a]/80 backdrop-blur-lg border-b border-[#334155] px-4 py-4 md:px-8 md:py-4">
      <nav className="max-w-7xl mx-auto flex">
        ...
        <div className="ml-auto flex items-center">
          <button className="px-4 py-2 bg-[#1e293b] text-[#3eddfd] font-semibold rounded-lg border border-[#3eddfd]/30 hover:bg-[#334155] hover:border-[#3eddfd]/50 transition-all text-sm">
            Connect Wallet
          </button>
        </div>
      </nav>
